...
#define TCS_SDA_X GPIOC
#define TCS_SDA_CLOCK RCC_APB2Periph_GPIOC

#define TCS_SCL_PIN GPIO_Pin_4
...
#define TCS_SDA_READ GPIO_ReadInputDataBit(TCS_SDA_X, GPIO_Pin_3)

#define TCS_SCL_H     GPIO_SetBits(GPIOB,GPIO_Pin_4)
#define TCS_SCL_L     GPIO_ResetBits(GPIOB,GPIO_Pin_4)
#define TCS_SDA_H     GPIO_SetBits(GPIOC,GPIO_Pin_3)
#define TCS_SDA_L     GPIO_ResetBits(GPIOC,GPIO_Pin_3)
/******************************************************************************/
