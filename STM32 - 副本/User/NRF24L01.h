...
//设置引脚电平
#define SI24R1_CSN_LOW   GPIOC->BRR  |= GPIO_Pin_6
#define SI24R1_CSN_HIGH  GPIOC->BSRR |= GPIO_Pin_6
#define SI24R1_CE_LOW    GPIOC->BRR  |= GPIO_Pin_5
#define SI24R1_CE_HIGH   GPIOC->BSRR |= GPIO_Pin_5
