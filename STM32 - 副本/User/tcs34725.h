...
#include "sys.h"
#define TCS_SDA_PIN GPIO_Pin_4
#define TCS_SDA_X GPIOB
#define TCS_SDA_CLOCK RCC_APB2Periph_GPIOB

#define TCS_SCL_PIN GPIO_Pin_5
#define TCS_SCL_X GPIOB
#define TCS_SCL_CLOCK RCC_APB2Periph_GPIOB
/******************************************************************************/
#define TCS34725_ADDRESS          (0x5a)
...
#define TCS_SDA_IN()   TCS_SDA_In()
#define TCS_SDA_OUT()  TCS_SDA_Out()
#define TCS_SDA_READ GPIO_ReadInputDataBit(TCS_SDA_X, TCS_SDA_PIN)

#define TCS_SCL_H GPIO_SetBits(TCS_SCL_X, TCS_SCL_PIN)
#define TCS_SCL_L GPIO_ResetBits(TCS_SCL_X, TCS_SCL_PIN)
#define TCS_SDA_H GPIO_SetBits(TCS_SDA_X, TCS_SDA_PIN)
#define TCS_SDA_L GPIO_ResetBits(TCS_SDA_X, TCS_SDA_PIN)
/******************************************************************************/
